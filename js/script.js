document.addEventListener('DOMContentLoaded', () => {
	...
	document.querySelector('.converter__btn').addEventListener('click', () => {
		...
		// Получаем контент
		const data = document.querySelector('.converter__textarea');
		const dataContent = document.querySelector('.converter__textarea').value;
	...
	document.getElementById('clear').addEventListener('click', (e) => {
		document.querySelector('.converter__textarea').value = '';
	});
});
